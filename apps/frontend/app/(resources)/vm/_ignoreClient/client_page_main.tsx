    ...
    <DashboardLayout>
      <div className="flex-1 space-y-6 p-8">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">All Virtual Machine</h2>
            <p className="text-muted-foreground">Manage your Virtual Machine and configurations.</p>
          </div>
          <div className="flex items-center space-x-2">
            <Link href="/vm/create">
              <Button className="cursor-pointer">Launch VM</Button>
            </Link>
          </div>
        </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">
                {selectedProject === "all" ? "Total VM" : "Project VM"}
              </CardTitle>
            </CardHeader>
            <CardContent>
