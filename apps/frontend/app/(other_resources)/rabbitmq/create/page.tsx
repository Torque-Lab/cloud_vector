          ...
          <div className="md:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Instance Memory</label>
                    <Select value={dimensions} onChange={(e) => setDimensions(e.target.value)}>
                      <option value="128">256MB</option>
                      <option value="256">512MB</option>
                      <option value="512">1GB</option>
                      <option value="768">2GB</option>
                      <option value="1024">4GB</option>
                      <option value="1536">8GB</option>
          
                    </Select>
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Instance Storage</label>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Minimum CPU</label>
                    <Select value={capacity} onChange={(e) => setCapacity(e.target.value)}>
                      <option value="small">1vCPU</option>
                      <option value="medium">2vCPU</option>
                      <option value="large">4vCPU</option>
                      <option value="xlarge">8vCPU</option>
        
                    </Select>
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium">Maximum CPU</label>
                    <Select value={capacity} onChange={(e) => setCapacity(e.target.value)}>
                      <option value="small">10vCPU</option>
                      <option value="medium">12vCPU</option>
                      <option value="large">16vCPU</option>
                      <option value="xlarge">24vCPU</option>
            ...
            <div className="flex items-center space-x-4">
              <Button className="flex-1">Create Postgres</Button>
              <Link href="/postgres">
